  <template>
      ...
      <div class="phoneinput">
        <div @click="countryshow = true">+{{selectphone}}</div>
      ...
      <!-- <v-foot></v-foot> -->
      <v-country v-show="countryshow" class="country" @selectPhone="selectPhone"></v-country>
    </div>
  </template>
  ...
  import Country from '@/components/user/country.vue';
  export default{
    components:{
      'v-foot':Foot,
      'v-header':Header,
